...
var HTMLheaderRole = '<span class="role-span">%data%</span><hr>';
...
var HTMLonlineClasses = '<h3 class="target">Online Classes<span class="plus"><i class="fa fa-plus-circle" aria-hidden="true"></i></span><span class="minus"><i class="fa fa-minus-circle" aria-hidden="true"></i></span></h3>';
var HTMLonlineTitle = '<a href="#">%data%';
var HTMLonlineSchool = ' - %data%</a>';
var HTMLonlineDates = '<div class="date-text">%data%</div>';
var HTMLonlineURL = '<a class="online-link" href="#">%data%</a><br><br>';
